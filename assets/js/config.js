...
window.TRIPLEDB_CONFIG = {
  ...
  releaseLabel: "Search-enabled local build",
  updatePolicy: "Planned at least annually",
  contactEmail: "replace-with-project-email@example.org",
  repositoryUrl: "#",
  citationText: "TripleDB citation will be added after publication.",
